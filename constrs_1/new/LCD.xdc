...
set_property MARK_DEBUG true [get_nets {TOUCH_CONTROLLER/out_port[2]}]
set_property MARK_DEBUG true [get_nets {TOUCH_CONTROLLER/out_port[5]}]
set_property MARK_DEBUG true [get_nets {TOUCH_CONTROLLER/out_port[4]}]
set_property MARK_DEBUG true [get_nets {TOUCH_CONTROLLER/out_port[3]}]
set_property MARK_DEBUG true [get_nets {TOUCH_CONTROLLER/out_port[6]}]
set_property MARK_DEBUG true [get_nets {TOUCH_CONTROLLER/out_port[7]}]
set_property MARK_DEBUG true [get_nets {TOUCH_CONTROLLER/out_port[0]}]
set_property MARK_DEBUG true [get_nets {TOUCH_CONTROLLER/out_port[1]}]
...
connect_debug_port u_ila_0/probe1 [get_nets [list {TOUCH_CONTROLLER/out_port[0]} {TOUCH_CONTROLLER/out_port[1]} {TOUCH_CONTROLLER/out_port[2]} {TOUCH_CONTROLLER/out_port[3]} {TOUCH_CONTROLLER/out_port[4]} {TOUCH_CONTROLLER/out_port[5]} {TOUCH_CONTROLLER/out_port[6]} {TOUCH_CONTROLLER/out_port[7]}]]
create_debug_port u_ila_0 probe
